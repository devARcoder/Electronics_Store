...
const OfferProducts = () => {
  return (
    <div className="w-full py-14 bg-white">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-fit mx-auto">
  ...
  to={`/${item.type}`} 
          ...
          >
            {/* Overlay */}
            <div className="absolute inset-0 bg-zinc-50 opacity-0 translate-y-full group-hover:opacity-50 group-hover:translate-y-0 transition-all duration-500 ease-in-out rounded-lg pointer-events-none"></div>
