...
export const slides = [
  {
    id: 1,
    title: "Discover the Future of Smartwatches",
    description: "Style, innovation, and performance in one powerful device.",
    image: "/images/banner1.png",
  },
  {
    id: 2,
    title: "Stay Connected in Style",
    description: "Elegant designs with powerful technology inside.",
    image: "/images/banner2.png",
  },
  {
    id: 3,
    title: "Smart Fitness on Your Wrist",
    description: "Track health, stay active, and look great doing it.",
...
export const featuredItems = [
  ...
  },
  {
    id: "5",
    type: "LG",
    title: "LG Velvet 5G Smartphone (Aurora Silver)",
    price: "$289.00",
    oldPrice: "$399.00",
    discount: "28%",
  ...
  },
  {
    id: "8",
    type: "Samsung",
    title: "Samsung Galaxy Watch 5 Pro (Black Titanium)",
    price: "$219.00",
    oldPrice: "$349.99",
    discount: "37%",
...
export const leftSideData = [
  ...
  },
  {
    ...
    title: "Dior Forever Skin Glow Foundation",
    price: "$54.00",
  ...
  },
  {
    id: "left-4",
    brand: "Christian Dior",
    title: "Dior Addict Lip Glow Balm",
    price: "$40.00",
...
export const centerData = [
  {
    id: "center-1",
    brand: "Givenchy",
    title: "Givenchy L’Interdit Eau de Parfum (50ml)",
    price: "$125.00",
    oldPrice: "$145.00",
  ...
  },
  {
    id: "center-2",
    brand: "Givenchy",
    title: "Givenchy Gentlemen Only Intense (100ml)",
    price: "$105.00",
    oldPrice: "$130.00",
  ...
  },
  {
    id: "center-3",
    brand: "Givenchy",
    title: "Givenchy Irresistible Eau de Toilette",
    price: "$115.00",
    oldPrice: "$135.00",
